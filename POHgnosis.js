...
while (true) {
    ...
    await sleep(100)
    const response = await fetch('https://gateway.thegraph.com/api/d5c7982a40f63da9504805d11919004d/subgraphs/id/FFx16fGNSpdq2TpQer3KqpadP8UaLELS4Jocd1LtwAmG', {
        method: 'POST',
        headers: {
...
// Write as JSON array instead of plain text
writeFileSync("humans-gnosis.json", JSON.stringify(dedupe, null, 2));
